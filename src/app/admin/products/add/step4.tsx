...
export const CreateProductStep4 = ({ product, retrieveProductDetails }: { product?: ProductType, retrieveProductDetails: (productDetails: Step4Type) => void }) => {
    ...
    return (
        <div>
            <FormContainer title="Add Features">
